...
#define GRASS_STARTER (IS_FRLG ? SPECIES_BULBASAUR : SPECIES_DITTO)
#define FIRE_STARTER (IS_FRLG ? SPECIES_CHARMANDER : SPECIES_DITTO)
#define WATER_STARTER (IS_FRLG ? SPECIES_SQUIRTLE : SPECIES_DITTO)
