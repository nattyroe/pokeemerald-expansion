...
// Overworld Debug
#define DEBUG_OVERWORLD_MENU ENABLED_ON_RELEASE          // Enables an overworld debug menu to change flags, variables, giving Pokémon and more, accessed by holding R and pressing START while in the overworld by default.
...
// Battle Debug Menu
#define DEBUG_BATTLE_MENU ENABLED_ON_RELEASE // If set to TRUE, enables a debug menu to use in battles by pressing the Select button.
